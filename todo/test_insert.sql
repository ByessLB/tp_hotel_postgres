--! ATTENTION : l'initialisation des tables fait qu'il est nécessaire d'altérer la séquance 
--! des "id" qui sont en auto-incrémentation

--? Insérer au moins 2 stations

INSERT INT station (name, altitude) VALUES ('Le rocher Impératrice', 3000);
INSERT INT station (name, altitude) VALUES ('Le cube', 2200);
INSERT INT station (name, altitude) VALUES ('Pyramide', 2000);
...
INSERT INTO client (first_name, last_name, address, city) VALUES ('Abienenc***', 'Akim', 'Rue de la tiz', 'Paris');